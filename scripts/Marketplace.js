...
describe("Marketplace", () => {
    it("Should create items and execute market sales", async () => {
        ...
        // Moshkel injas
        // Bayad khodemun gheimato tayin konim
        ...
        console.log("Fetching price per token for Token Id 1...");
        response = await market.pricePerTokenGetter(NFT.address, 1);
        console.log(`Price per token for Token Id 1 : ${response.toNumber()} Matic`)

        console.log("Fetching price per token for Token Id 2...");
        response = await market.pricePerTokenGetter(NFT.address, 2);
        console.log(`Price per token for Token Id 2 : ${response.toNumber()} Matic`)
